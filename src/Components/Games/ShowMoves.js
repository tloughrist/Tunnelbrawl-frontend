...
export default function showMoves(boardState, spaceId, clearHighlight, highlight, setActivePiece) {
  ...
  if (isHand(spaceId, pieceColor)) {
    switch(pieceColor) {
      case "red":
        calcVacancies(boardState, "red")
        moves = {piece: calcVacancies(boardState, "red"), capture: []};
        break;
      case "green":
        calcVacancies(boardState, "green")
        moves = {piece: calcVacancies(boardState, "red"), capture: []};
        break;
      case "blue":
        calcVacancies(boardState, "blue")
        moves = {piece: calcVacancies(boardState, "red"), capture: []};
        break;
      case "yellow":
        calcVacancies(boardState, "yellow")
        moves = {piece: calcVacancies(boardState, "red"), capture: []};
        break;
      default:
        return;
